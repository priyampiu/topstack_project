                ...
                <div class="form">
                    ...
                    <form class="signUp" action="control.php" method="post" enctype="multipart/form-data">
                            <div class="formGroup">
                                ...
                                <input type="text" name="date" placeholder="Enter Notice Date" required/>
                            </div>
                            <div class="formGroup">
                                <i class="bi bi-chat-right-text-fill"></i>
                                <input type="text" name="sub"  placeholder="Enter Notic Subject"  required/>
                            </div>
                            <div class="formGroup">
                            ...
                            <br>
                            <input type="submit" name="an" value="ADD" class="btn2">
                    </form>
                </div>
            </div>
        </body>
