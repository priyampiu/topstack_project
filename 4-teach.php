...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/4_teach.css">
    </head>
                    ...
                    <table width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><h5><?=$T['Name'];?></h5></td>
                                <td><h5><?=$T['Email'];?></h5></td>
                                <td><h5><?=$T['Contact'];?></h5></td>
                                <td><h5><?=$T['Dept_Id'];?></h5></td>
                                <td><h5><?=$T['Subject'];?></h5></td>
                                <td class="action">
                                        <a href="edit_teach.php?id=<?=$T['ID'];?>"><i class="bi bi-pencil-fill"></i></a>
                                        <a href="control.php?id=<?=$T['ID'];?>&name=<?='dlt-teach';?>">
