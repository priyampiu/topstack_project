...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/3_dept.css">
    </head>
                    ...
                    <table width="100%">
                        ...
                        <tbody>
                            <?php foreach($d as $D){?>
                                <tr>
                                    <td><h5><?=$D['ID'];?></td>
                                    <td><h5><?=$D['Department'];?></h5></td>
                                    <td class="action">
                                            <input type="hidden" name="id" value="<?php echo $D['ID'] ?>">
                                            <a href="edit_dept.php?id=<?=$D['ID'];?>"><i class="bi bi-pencil-fill"></i></a>
                                            <a href="control.php?id=<?=$D['ID'];?>&name=<?='dlt-dept';?>">
